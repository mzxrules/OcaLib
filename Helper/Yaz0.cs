...
namespace mzxrules.OcaLib.Helper
{
    public class Yaz0
    {
        ...
        /// </summary>
        /// <param name="sr">Stream pointing to yaz0 block</param>
        ...
        /// <summary>
        /// Decompresses a block compressed with the Yaz0 algorithm with respect to a little endian machine
        /// </summary>
        /// <param name="sr"></param>
        /// <param name="yaz0BlockSize">The size of the block without header?</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Decodes a Yaz0 block
        /// </summary>
        /// <param name="src">points to the yaz0 source data (to the "real" source data, not at the header!)</param>
        /// <param name="dst">points to a buffer uncompressedSize bytes large (you get uncompressedSize from</param>
        /// <param name="uncompressedSize">the second 4 bytes in the Yaz0 header)</param>
